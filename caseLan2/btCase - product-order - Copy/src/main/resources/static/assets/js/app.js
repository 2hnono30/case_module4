class App {
    ...
    static AlertMessageVi = class {
        ...
        static SUCCESS_DEACTIVATE_USER = "Xóa sản user thành công !";
    ...
    static SweetAlert = class {
        ...
        static showAlertError(t) {
            Swal.fire({
                position: 'bottomLeft', icon: 'error', title: t, showConfirmButton: true
            })
        }
...
// <a className="btn btn-outline-secondary edit" data-id="${obj.id}" title="" data-bs-toggle="tooltip"  data-bs-original-title="Edit">
