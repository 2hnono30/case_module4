class AppPage {
  ...
  <img src="${this.BASE_CLOUDIARY_IMAGE_URL}/${avatar.fileFolder}/${avatar.fileName}" class="card-img-top" alt="..." style="height: 270px">
  <div class="card-body">
    ...
    <p class="card-text" style="text-align: center">${new Intl.NumberFormat('vi-VN', {
     ...
     <a href="#" class="btn btn-primary add-cart" data-id="${obj.id}">Thêm vào giỏ</a>
  </div>
</div>
        `
    }
    ...
    static renderCartItem(obj) {
        return `
            <div id="ci_${obj.id}" class="card mb-3" style="max-width: 100%;height: 120px;">
                <div class="row g-0">
                    <div class="col-md-4">
