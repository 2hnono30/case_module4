...
public class UserServiceImpl implements UserService{
    ...
    @Override
    public List<User> findUserByDeletedIsFalse() {
        return userRepository.findUserByDeletedIsFalse();
    }

    @Override
    public List<User> findUserByDeletedIsTrue() {
        return userRepository.findUserByDeletedIsTrue();
    }
    ...
    @Override
    public User deleteRecoveUser(User user) {
        LocationRegion locationRegion = locationRegionRepository.save(user.getLocationRegion());
        user.setLocationRegion(locationRegion);
        return userRepository.save(user);
    }
